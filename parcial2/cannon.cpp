...
void cannon::protegerDefandOfen(float Yo, float Yd, float RD, float Xd, int angleO, int VO)
{
    int flag = 0;
    bool flag2 = 0;
    float x,y,x2,y2;
        ...
        for(angle = 0; angle < 90; angle++){
            ...
            for(t = 0; ; t++){
                ...
                if(sqrt(pow((x2 - x),2)+pow((y2 - y),2)) < RD){
                    ...
                    if (verificar_impactoOfen(Yo,Xd,Yd, RD,angleO, VO)==false) {
...
bool cannon::verificar_impactoDef(float Yo, float Xd, float Yd, float RO,int angleO,int VO)
{
...
bool cannon::verificar_impactoOfen(float Yo, float Xd, float Yd, float RD,int angleO,int VO)
{
    int flag = 0;
    float x=0.0,y=0.0;
    float Vxo,Vy0;
